...
const Person: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg
    height="200px"
    width="200px"
    viewBox="0 0 512 512"
    ...
    {...props}
  >
    <style type="text/css">{'.st0{fill:#f5efef;}'}</style>
    <g>
      <path
        className="st0"
      ...
      <path
        className="st0"
        d="M256.005,300.641c74.144,0,134.231-60.108,134.231-134.242v-32.158
